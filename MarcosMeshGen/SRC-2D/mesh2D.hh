...
protected:
  ...
  bool   ms_status ;
  double ms_hmax, ms_hmin, ms_hsqr, ms_havg ;
...
double mesh_2Dv :: eval_mesh_size( string retstr ) {
  ...
  else if ( retstr=="havg" ) { retval = ms_havg ; }
  else                       { retval = 0.      ; }
  return retval ;
}
inline double mesh_2Dv :: h_avg() { return ms_status ? ms_havg : eval_mesh_size("havg") ; }
