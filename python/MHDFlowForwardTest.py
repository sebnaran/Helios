...
#WithElectromagnetics with theta=1/2
#def f(xv,t):
...
#WithElectromagnetics with theta=1
def f(xv,t):
...
for MType in MTypes:
    ...
    for Pfile in ProcessedFiles:
        ...
        #    luntx ,lunty ,lumtx ,lumty  = PDE.GetLocalTVhDOF(i,PDE.unx,PDE.uny,PDE.umx,PDE.umy)
        #    Divu,A                      = PDE.DIVu(i,luntx,lunty,lumtx,lumty)
            #print(Divu)
        #print(f'y={y}')
